			...
			<ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                 ...
                 <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="fnr.php">Food and Restaurants</a></li>
                        ...
                        <li><a href="socialnet">Social Networking</a></li>
                        <li class="divider"></li>
                        <li><a href="allreviews.php">See All..</a></li>
                  </ul>
                </li>

                <li><a href="about.php" ><span class="glyphicon glyphicon-family"></span> About Us</a></li>
