			...
			<ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                 ...
                 <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="categories/fnr.php">Food and Restaurants</a></li>
                        <li><a href="categories/sports.php">Sports</a></li>
                        <li><a href="categories/entertainment.php">Entertainment & Movies</a></li>
                        <li><a href="categories/hnf.php">Health and Fitness</a></li>
                        <li><a href="categories/music.php">Music</a></li>
                        <li><a href="categories/olgames.php">Online Games</a></li>
                        <li><a href="categories/socialnet.php">Social Networking</a></li>
                        <li class="divider"></li>
                        <li><a href="categories/allcategories.php">See All..</a></li>
                  </ul>
                </li>
